...
{
    /// <summary>
    /// This exception is thrown by the <see cref="Delta.Ioc.ServiceExtensions.GetService&lt;T&gt;(System.IServiceProvider)"/>
    /// method, when specifying the <b>mandatory</b> parameter and when the requested service is not found.
    /// </summary>
    [Serializable]
    public class ServiceNotFoundException : ActivationException
    {
