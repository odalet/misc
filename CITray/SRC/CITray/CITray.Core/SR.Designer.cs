...
namespace CITray {
    ...
    internal class SR {
        ...
        internal static string ServiceNotFoundDefaultMessage {
            get {
                return ResourceManager.GetString("ServiceNotFoundDefaultMessage", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Service of type {0} couldn&apos;t be found: {1}.
        /// </summary>
